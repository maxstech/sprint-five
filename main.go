...
func (r Running) Calories() float64 {
	avgSpeedKmh := r.meanSpeed()
	return ((CaloriesMeanSpeedMultiplier*avgSpeedKmh +
...
func (w Walking) Calories() float64 {
	...
	avgSpeedMps := w.meanSpeed() * KmHInMsec
	heightM := w.Height / CmInM
	return ((CaloriesWeightMultiplier*w.Weight +
		(math.Pow(avgSpeedMps, 2.0)/(heightM))*
...
func (s Swimming) Calories() float64 {
	...
	return (avgSpeed + SwimmingCaloriesMeanSpeedShift) *
